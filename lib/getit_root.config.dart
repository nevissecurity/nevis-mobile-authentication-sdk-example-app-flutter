...
import 'domain/blocs/local_data/local_data_bloc.dart' as _i54;
...
import 'domain/interaction/device_passcode_user_verifier.dart' as _i53;
...
import 'domain/model/operation/pin_change_state.dart' as _i8;
import 'domain/model/operation/pin_enrollment_state.dart' as _i9;
import 'domain/model/operation/user_interaction_operation_state.dart' as _i10;
...
import 'domain/usecase/auth_cloud_api_register_usecase.dart' as _i63;
import 'domain/usecase/authenticate_usecase.dart' as _i65;
import 'domain/usecase/authenticators_usecase.dart' as _i66;
...
import 'domain/usecase/change_device_information_usecase.dart' as _i67;
...
import 'domain/usecase/deregister_all_usecase.dart' as _i50;
import 'domain/usecase/deregister_usecase.dart' as _i51;
import 'domain/usecase/device_information_usecase.dart' as _i52;
...
import 'domain/usecase/oob_payload_decode_usecase.dart' as _i55;
import 'domain/usecase/oob_process_usecase.dart' as _i56;
import 'domain/usecase/pause_listening_usecase.dart' as _i33;
import 'domain/usecase/provided_pins_usecase.dart' as _i37;
import 'domain/usecase/registered_accounts_usecase.dart' as _i59;
...
import 'ui/screens/change_device_information/change_device_information_bloc.dart'
    as _i73;
import 'ui/screens/home/home_bloc.dart' as _i69;
import 'ui/screens/legacy_login/legacy_login_bloc.dart' as _i70;
import 'ui/screens/pin/pin_bloc.dart' as _i57;
import 'ui/screens/read_qr_code/read_qr_code_bloc.dart' as _i58;
import 'ui/screens/result/result_bloc.dart' as _i61;
import 'ui/screens/select_account/select_account_bloc.dart' as _i71;
import 'ui/screens/select_authenticator/select_authenticator_bloc.dart' as _i62;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i56.OobProcessUseCase>(() => _i56.OobProcessUseCaseImpl(
        ...
        gh<_i55.OobPayloadDecodeUseCase>(),
  ...
  gh.factory<_i58.ReadQrCodeBloc>(() => _i58.ReadQrCodeBloc(
        gh<_i56.OobProcessUseCase>(),
        gh<_i29.ErrorHandler>(),
      ));
  gh.factory<_i59.RegisteredAccountsUseCase>(
      () => _i59.RegisteredAccountsUseCaseImpl(gh<_i49.ClientProvider>()));
  ...
  gh.factory<_i63.AuthCloudApiRegisterUseCase>(
      () => _i63.AuthCloudApiRegisterUseCaseImpl(
            gh<_i49.ClientProvider>(),
            gh<_i12.CreateDeviceInformationUseCase>(),
            gh<_i31.AuthenticatorSelector>(instanceName: 'auth_selector_reg'),
            gh<_i31.PinEnroller>(),
  ...
  gh.factory<_i64.AuthCloudApiRegistrationBloc>(
      () => _i64.AuthCloudApiRegistrationBloc(
            gh<_i16.GlobalNavigationManager>(),
            gh<_i63.AuthCloudApiRegisterUseCase>(),
            gh<_i29.ErrorHandler>(),
          ));
  gh.factory<_i65.AuthenticateUseCase>(() => _i65.AuthenticateUseCaseImpl(
        gh<_i49.ClientProvider>(),
        gh<_i31.AuthenticatorSelector>(instanceName: 'auth_selector_auth'),
        gh<_i31.BiometricUserVerifier>(),
        gh<_i31.DevicePasscodeUserVerifier>(),
  ...
  gh.factory<_i66.AuthenticatorsUseCase>(
      () => _i66.AuthenticatorsUseCaseImpl(gh<_i49.ClientProvider>()));
  ...
  gh.factory<_i69.HomeBloc>(() => _i69.HomeBloc(
        ...
        gh<_i49.ClientProvider>(),
        gh<_i56.OobProcessUseCase>(),
        gh<_i59.RegisteredAccountsUseCase>(),
        gh<_i50.DeregisterAllUseCase>(),
        gh<_i66.AuthenticatorsUseCase>(),
        gh<_i68.ChangePinUseCase>(),
        gh<_i54.LocalDataBloc>(),
        gh<_i29.ErrorHandler>(),
        gh<_i16.GlobalNavigationManager>(),
      ));
  gh.factory<_i70.LegacyLoginBloc>(() => _i70.LegacyLoginBloc(
        gh<_i11.ConfigurationLoader>(),
        gh<_i20.LoginUseCase>(),
        gh<_i60.RegistrationUseCase>(),
        gh<_i29.ErrorHandler>(),
      ));
  gh.factory<_i71.SelectAccountBloc>(() => _i71.SelectAccountBloc(
        gh<_i65.AuthenticateUseCase>(),
        gh<_i40.SelectAccountUseCase>(),
        gh<_i68.ChangePinUseCase>(),
        gh<_i29.ErrorHandler>(),
        gh<_i16.GlobalNavigationManager>(),
  ...
  gh.singleton<_i72.AppBloc>(_i72.AppBloc(
    ...
    gh<_i66.AuthenticatorsUseCase>(),
    gh<_i51.DeregisterUseCase>(),
    gh<_i11.ConfigurationLoader>(),
    gh<_i29.ErrorHandler>(),
    gh<_i28.DomainBloc>(),
    gh<_i16.GlobalNavigationManager>(),
  ));
  gh.factory<_i73.ChangeDeviceInformationBloc>(
      () => _i73.ChangeDeviceInformationBloc(
            gh<_i16.GlobalNavigationManager>(),
            gh<_i67.ChangeDeviceInformationUseCase>(),
            gh<_i52.DeviceInformationUseCase>(),
            gh<_i29.ErrorHandler>(),
          ));
  return getIt;
}
