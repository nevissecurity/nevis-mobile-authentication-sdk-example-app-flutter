...
import 'domain/batch_call/batch_call.dart' as _i49;
import 'domain/blocs/domain_state/domain_bloc.dart' as _i28;
import 'domain/blocs/local_data/local_data_bloc.dart' as _i62;
import 'domain/client_provider/client_provider.dart' as _i52;
...
import 'domain/interaction/authentication_authenticator_selector_impl.dart'
    as _i46;
import 'domain/interaction/biometric_user_verifier_impl.dart' as _i50;
import 'domain/interaction/device_passcode_user_verifier_impl.dart' as _i51;
import 'domain/interaction/fingerprint_user_verifier_impl.dart' as _i57;
import 'domain/interaction/password_changer.dart' as _i32;
import 'domain/interaction/password_enroller.dart' as _i40;
import 'domain/interaction/password_user_verifier.dart' as _i55;
import 'domain/interaction/pin_changer_impl.dart' as _i33;
import 'domain/interaction/pin_enroller_impl.dart' as _i43;
import 'domain/interaction/pin_user_verifier_impl.dart' as _i53;
...
import 'domain/usecase/biometric_listen_for_os_credentials_usecase.dart'
    as _i27;
import 'domain/usecase/cancel_credential_operation_usecase.dart' as _i60;
...
import 'domain/usecase/change_password_usecase.dart' as _i61;
import 'domain/usecase/change_pin_usecase.dart' as _i70;
import 'domain/usecase/create_device_information_usecase.dart' as _i71;
import 'domain/usecase/delete_authenticators_usecase.dart' as _i58;
import 'domain/usecase/deregister_all_usecase.dart' as _i63;
import 'domain/usecase/deregister_usecase.dart' as _i64;
...
import 'domain/usecase/oob_process_usecase.dart' as _i75;
...
import 'domain/usecase/registered_accounts_usecase.dart' as _i54;
import 'domain/usecase/registration_usecase.dart' as _i72;
...
import 'ui/app_state/app_bloc.dart' as _i77;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i49.BatchCall>(() => _i49.BatchCallImpl(
        gh<_i28.DomainBloc>(),
        gh<_i41.ErrorHandler>(),
      ));
  gh.factory<_i15.BiometricUserVerifier>(() => _i50.BiometricUserVerifierImpl(
        gh<_i28.DomainBloc>(),
        gh<_i41.ErrorHandler>(),
        gh<_i12.StateRepository<_i9.UserInteractionOperationState>>(),
      ));
  gh.factory<_i15.DevicePasscodeUserVerifier>(
      () => _i51.DevicePasscodeUserVerifierImpl(
            gh<_i28.DomainBloc>(),
            gh<_i41.ErrorHandler>(),
            gh<_i12.StateRepository<_i9.UserInteractionOperationState>>(),
          ));
  gh.factory<_i52.ClientProvider>(() => _i52.ClientProviderImpl(
        gh<_i12.StateRepository<_i6.OperationType>>(),
        gh<_i41.ErrorHandler>(),
      ));
  gh.factory<_i15.PinUserVerifier>(() => _i53.PinUserVerifierImpl(
        gh<_i28.DomainBloc>(),
        gh<_i41.ErrorHandler>(),
        gh<_i12.StateRepository<_i9.UserInteractionOperationState>>(),
      ));
  gh.factory<_i54.RegisteredAccountsUseCase>(
      () => _i54.RegisteredAccountsUseCaseImpl(gh<_i52.ClientProvider>()));
  gh.factory<_i15.PasswordUserVerifier>(() => _i55.PasswordUserVerifierImpl(
        gh<_i28.DomainBloc>(),
        gh<_i41.ErrorHandler>(),
        gh<_i12.StateRepository<_i9.UserInteractionOperationState>>(),
      ));
  gh.factory<_i56.SelectAuthenticatorBloc>(() => _i56.SelectAuthenticatorBloc(
        gh<_i37.SelectAuthenticatorUseCase>(),
        gh<_i3.GlobalNavigationManager>(),
        gh<_i41.ErrorHandler>(),
      ));
  gh.factory<_i15.FingerprintUserVerifier>(
      () => _i57.FingerprintUserVerifierImpl(
            gh<_i28.DomainBloc>(),
            gh<_i41.ErrorHandler>(),
            gh<_i12.StateRepository<_i9.UserInteractionOperationState>>(),
          ));
  gh.factory<_i58.DeleteAuthenticatorsUseCase>(
      () => _i58.DeleteAuthenticatorsUseCaseImpl(
            gh<_i52.ClientProvider>(),
            gh<_i12.StateRepository<_i6.OperationType>>(),
          ));
  gh.factory<_i59.ConfirmationBloc>(() => _i59.ConfirmationBloc(
  ...
  gh.factory<_i60.CancelCredentialOperationUseCase>(
      () => _i60.CancelCredentialOperationUseCaseImpl(
            gh<_i12.StateRepository<_i23.PinEnrollmentState>>(),
            gh<_i12.StateRepository<_i10.PasswordEnrollmentState>>(),
            gh<_i12.StateRepository<_i20.PinChangeState>>(),
            gh<_i12.StateRepository<_i14.PasswordChangeState>>(),
          ));
  gh.factory<_i61.ChangePasswordUseCase>(() => _i61.ChangePasswordUseCaseImpl(
        gh<_i52.ClientProvider>(),
  ...
  gh.singleton<_i62.LocalDataBloc>(() => _i62.LocalDataBloc(
        gh<_i52.ClientProvider>(),
        gh<_i41.ErrorHandler>(),
      ));
  gh.factory<_i63.DeregisterAllUseCase>(() => _i63.DeregisterAllUseCaseImpl(
        gh<_i52.ClientProvider>(),
        gh<_i12.StateRepository<_i6.OperationType>>(),
      ));
  gh.factory<_i64.DeregisterUseCase>(() => _i64.DeregisterUseCaseImpl(
        gh<_i52.ClientProvider>(),
        gh<_i12.StateRepository<_i6.OperationType>>(),
      ));
  ...
  gh.factory<_i67.AuthenticatorsUseCase>(
      () => _i67.AuthenticatorsUseCaseImpl(gh<_i52.ClientProvider>()));
  ...
  gh.factory<_i69.DeviceInformationUseCase>(
      () => _i69.DeviceInformationUseCaseImpl(gh<_i52.ClientProvider>()));
  ...
  gh.factory<_i71.CreateDeviceInformationUseCase>(() =>
      _i71.CreateDeviceInformationUseCaseImpl(
          gh<_i69.DeviceInformationUseCase>()));
  gh.factory<_i72.RegistrationUseCase>(() => _i72.RegistrationUseCaseImpl(
        gh<_i52.ClientProvider>(),
  ...
  gh.factory<_i73.ResultBloc>(() => _i73.ResultBloc(
        gh<_i3.GlobalNavigationManager>(),
        gh<_i62.LocalDataBloc>(),
        gh<_i12.StateRepository<_i6.OperationType>>(),
      ));
  gh.factory<_i74.CredentialBloc>(() => _i74.CredentialBloc(
        gh<_i28.DomainBloc>(),
        gh<_i60.CancelCredentialOperationUseCase>(),
  ...
  gh.factory<_i75.OobProcessUseCase>(() => _i75.OobProcessUseCaseImpl(
        gh<_i52.ClientProvider>(),
        gh<_i71.CreateDeviceInformationUseCase>(),
  ...
  gh.factory<_i76.ChangeDeviceInformationBloc>(
      () => _i76.ChangeDeviceInformationBloc(
            gh<_i3.GlobalNavigationManager>(),
            gh<_i65.ChangeDeviceInformationUseCase>(),
            gh<_i69.DeviceInformationUseCase>(),
            gh<_i41.ErrorHandler>(),
          ));
  gh.singleton<_i77.AppBloc>(() => _i77.AppBloc(
        gh<_i67.AuthenticatorsUseCase>(),
        gh<_i64.DeregisterUseCase>(),
        gh<_i21.ConfigurationLoader>(),
        gh<_i41.ErrorHandler>(),
        gh<_i28.DomainBloc>(),
        gh<_i3.GlobalNavigationManager>(),
